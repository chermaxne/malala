...
async function main() {
    ...
    // Extract the transaction hash from the logs or modifying registerDID to return it would be better,
    // but for now, let's just tell them to look up the account.
    console.log(`\n>>> MANUAL VERIFICATION <<<`);
    console.log(`View the Account and Transactions here:`);
    console.log(`https://testnet.xrpl.org/accounts/${wallet.address}`);
    console.log(`Look for a 'DIDSet' transaction type.\n`);
